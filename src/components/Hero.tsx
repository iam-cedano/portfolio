...
const Hero: React.FC = () => {
  return (
    <section id="home" className="bg-[#1e2330] text-white py-32 flex flex-col items-center justify-center text-center">
      <h1 className="text-5xl md:text-6xl font-bold mb-6">Hola, soy Oscar Cedano</h1>
      <h2 className="text-3xl md:text-4xl font-bold text-blue-600 mb-10">Desarrollador FullStack</h2>
